...
type FontAwesomeIconProps = ThemeProps &
  Omit<ComponentProps<typeof FontAwesome>, 'color'> & {
    library: 'FontAwesome'
    color?: string
  }

type IoniconsIconProps = ThemeProps &
  Omit<ComponentProps<typeof Ionicons>, 'color'> & {
    library: 'Ionicons'
    color?: string
  }
...
export function Icon(props: IconProps) {
  ...
  if (library === 'Ionicons') {
    return (
      <Ionicons
        color={resolvedColor}
        {...(otherProps as Omit<ComponentProps<typeof Ionicons>, 'color'>)}
      />
    )
  }
  ...
  return (
    <FontAwesome
      color={resolvedColor}
      {...(otherProps as Omit<ComponentProps<typeof FontAwesome>, 'color'>)}
    />
  )
}
