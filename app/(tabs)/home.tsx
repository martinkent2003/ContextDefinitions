...
export default function Home() {
  ...
  const handleInsertSamples = async () => {
    showLoading("Loading sample readings...", "book");
    try {
      await insertSampleReadings();
